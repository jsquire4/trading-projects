...
export function NetworkBadge() {
  ...
  return (
    <span
      className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-[10px] font-semibold tracking-wider uppercase ${BADGE_STYLES[cluster]}`}
    >
      {BADGE_LABELS[cluster]}
    </span>
  );
}
