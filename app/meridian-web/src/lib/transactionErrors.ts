/**
 * Meridian program error codes and transaction error extraction.
 *
 * Extracted from useTransaction.ts to keep the hook focused on the
 * sign-send-confirm lifecycle while making error parsing reusable.
 */
